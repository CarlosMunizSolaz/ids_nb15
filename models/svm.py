...
# Fecha: Enero 2020
#
# Utiliza clasificador support vector machine para clasificar el data set de entrenamiento de NB 15
###################################################################################
...
### gammas= [0.000001, 0.01, 10, 100, 500, 1000]
### for gamma2 in gammas:
###     print (gamma2)
###     svm = SVC(kernel='rbf', C=453.24366629, gamma=gamma2)
...
### plt.xticks(gammas)
### plt.tight_layout()
### print("La mejor precisión en el conjunto de test es {} con gamma = {}".format(np.max(test_accuracy),
